    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
                ...
                <button
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-ocean-500 text-white hover:bg-ocean-500/90"
                >
            ...
            <div className="flex flex-col md:flex-row gap-3 md:items-center md:justify-between">
                <div className="flex gap-3 items-center w-full md:w-auto">
                    <div className="relative w-full md:w-80">
                        ...
                        <input
                            placeholder="Tìm theo tên, SĐT, địa chỉ, nội dung…"
                            className="w-full pl-9 pr-3 py-2 rounded-lg border border-ocean-100 bg-white"
                        />
                    </div>
                    <select className="px-3 py-2 rounded-lg border border-ocean-100 bg-white">
                ...
                <button
                    className="inline-flex items-center gap-2 px-3 py-2 rounded-lg border border-ocean-100 hover:bg-ocean-100/50"
                >
                    <ArrowUpDown className="w-4 h-4" />
                    Sắp xếp theo tên {true ? "(A→Z)" : "(Z→A)"}
                </button>
            </div>
                            ...
                            >
                                ...
                                <td className="px-4 py-3">
                                    <div className="flex items-center justify-center gap-2">
                                        ...
                                        <button
                                            ...
                                            className="text-xs px-2 py-1 rounded border border-ocean-100 hover:bg-ocean-100/50"
                                        >
                                            Đổi
                                        </button>
                                    </div>
                                ...
                                <td className="px-4 py-3">
                                    <div className="flex items-center justify-end gap-2">
                                        <button
                                            onClick={() => openEdit(r)}
                                            className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg border border-ocean-100 hover:bg-ocean-100/50"
                                        >
                    ...
                    <div className="w-full max-w-2xl rounded-xl bg-white p-5">
                        ...
                        >
                            ...
                            <input
                                ...
                                value={form.phuong}
                                onChange={(e) =>
                                    setForm({ ...form, phuong: e.target.value })
                                }
                                className="px-3 py-2 rounded-lg border border-ocean-100"
                            />
                            <input
                                ...
                                value={form.quan}
                                onChange={(e) =>
                                    setForm({ ...form, quan: e.target.value })
                                }
                                className="px-3 py-2 rounded-lg border border-ocean-100"
                            />
                            <textarea
                    ...
                    <div className="w-full max-w-md rounded-xl bg-white p-5">
                        <div className="mb-3">
                            ...
                            <p className="text-sm text-ocean-500">
                                Bạn có chắc muốn xoá yêu cầu của{" "}
                                <b>{delTarget?.ho_va_ten}</b>?
                            </p>
                        </div>

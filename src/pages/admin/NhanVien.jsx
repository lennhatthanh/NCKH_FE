                    ...
                    <tbody className="divide-y divide-ocean-100">
                        ...
                        {list.length === 0 && (
                            <tr>
                                <td
                                    colSpan={8}
                                    className="px-4 py-10 text-center text-ocean-500"
                                >
                                    Chưa có dữ liệu
                                </td>
                            </tr>
                        ...
                        <form onSubmit={handleSubmit} className="px-5 py-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                <div className="space-y-1.5">
                                    <label className="text-sm text-ocean-500">
                                        Họ và tên
                                    </label>
                                    <input
                                        required
                                ...
                                <div className="md:col-span-2">
                                    <label className="inline-flex items-center gap-2 text-sm text-ocean-700">
                                        <input
                                            type="checkbox"
                                            checked={
                                                Number(form.tinh_trang) === 1
                                            }
                                            onChange={(e) =>
                                                setForm({
                                                    ...form,
                                                    tinh_trang: e.target.checked
                                                        ? 1
                                                        : 0,
                                                })
                                            }

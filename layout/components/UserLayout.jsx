...
export default function UserLayout() {
  ...
  const linkBase =
    "relative px-3 py-2 text-sm font-medium text-ocean-700 hover:text-ocean-900 transition";
  const linkActive =
    "text-ocean-900 after:absolute after:left-0 after:-bottom-0.5 after:h-[2px] after:w-full after:bg-ocean-500";

  return (
    <div className="min-h-screen bg-ocean-50 text-ocean-900 flex flex-col">
      {/* NAVBAR */}
      <header
        className={`sticky top-0 z-50 ${
          scrolled
            ? "bg-white/95 backdrop-blur border-b border-ocean-100"
            : "bg-white/80"
        }`}
      >
